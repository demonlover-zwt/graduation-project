...
ax.axline((0, 0), slope=-sound_speed, color='red', linestyle='-', linewidth=2)
# ax.axline((0, 0), slope=sound_speed/np.cos(47/180*np.pi), color='red', linestyle='--', linewidth=2)
# ax.axline((0, 0), slope=-sound_speed/np.cos(47/180*np.pi), color='red', linestyle='--', linewidth=2)

plt.savefig("./实测_fk（未截取）.png", dpi=600, bbox_inches='tight')
plt.close()
...
plt.savefig("./实测_fk（截取）.png", dpi=600, bbox_inches='tight')
plt.close()
