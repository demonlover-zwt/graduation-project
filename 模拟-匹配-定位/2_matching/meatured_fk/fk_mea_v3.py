...
ax.axhline(y=49.365, color='green', linestyle='--', linewidth=1.5)

ax.axline((0, 0), slope=sound_speed, color='red', linestyle='-', linewidth=2)
ax.axline((0, 0), slope=-sound_speed, color='red', linestyle='-', linewidth=2)
ax.axline((0, 0), slope=2200, color='red', linestyle='--', linewidth=1.5)
ax.axline((0, 0), slope=-2200, color='red', linestyle='--', linewidth=1.5)

plt.savefig("./实测_fk（未截取）_v3.png", dpi=600, bbox_inches='tight')
plt.close()
...
plt.savefig("./实测_fk（截取）_v3.png", dpi=600, bbox_inches='tight')
plt.close()
